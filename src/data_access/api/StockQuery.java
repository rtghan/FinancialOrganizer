...
public class StockQuery implements InvestmentValueDataAccessInterface {
    ...
    public Double getPrice(String stockName, LocalDate purchaseDate) throws Exception{
        ...
        String response = getURLResponse(urlBase);

        JSONObject data = new JSONObject(response);
        BigDecimal price = (BigDecimal) data.get("close");
